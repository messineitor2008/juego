...
var gameState="play"
var fondoFin
var rayoSound,backgroundSound,muerte

function preload() {
backgroundImage=loadImage("espacio.jpg")
fondoFin=loadImage("espacio.gif")
...
rayoSound=loadSound("MachineGunShells.mp3")
backgroundSound=loadSound("el-ejercito_1.mp3")
  ...
  swal(
    {
      ...
      imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmi8Ah5vekPUiOe-mYPSIEOtwIcJ3s52EzLkLCDvADtSTAaMMcR1zV3t4yFmXN6NygsTk&usqp=CAU",
      imageSize: "350x350",
